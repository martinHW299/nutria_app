...
class AnalyticsService {
  ...
  static Future<List<NutritionData>> getWeeklyIntake({
    ...
    try {
      ...
      if (res.statusCode == 200 && res.data['status'] == 200) {
        ...
        return weekData
            .map<NutritionData>((data) => NutritionData.fromJson(data))
            .toList();
      }

      // print(
      //   'Failed to get weekly intake data: ${res.statusCode} - ${res.data}',
      // );
      return [];
    } catch (e) {
  ...
  static Future<List<NutritionData>> getMonthlyIntake({
    required DateTime date,
  }) async {
    try {
      final formattedDate = DateFormat('yyyy-MM-dd').format(date);
      ...
      // print(
      //   'Failed to get monthly intake data: ${res.statusCode} - ${res.data}',
      // );
      return [];
    } catch (e) {
