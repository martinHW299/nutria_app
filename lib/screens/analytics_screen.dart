...
class _AnalyticsScreenState extends State<AnalyticsScreen>
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final foodTraceFuture = AnalyticsService.getFoodTraces(
        date: widget.selectedDate,
      );

      final nutritionDataFuture =
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Error al cargar los datos de análisis: $e')),
        );
      }
    }
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: WeightStatusChart(nutritionData: _nutritionData),
                      ),
                    ),
                  ],
                ),
